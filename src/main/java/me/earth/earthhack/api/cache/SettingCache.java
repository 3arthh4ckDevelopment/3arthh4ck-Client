        ...
        extends Cache<S>
{
    ...
    /**
     * Creates a new SettingCache that uses the Hud Module from the given
     * ModuleCache to get the setting by name and class.
     *
     * @param name the name of the setting to get.
     * @param type the type of the setting to get.
     * @param module the hud module the setting is registered in.
     * @param defaultValue the default value to return.
     * @param <T> the type of the settings values.
     * @param <S> the type of setting.
    ...
    SettingCache<T, S, E> newHudSettingCache(String name,
                                             Class<?> type,
                                             Cache<E> module,
                                             T defaultValue)
    {
