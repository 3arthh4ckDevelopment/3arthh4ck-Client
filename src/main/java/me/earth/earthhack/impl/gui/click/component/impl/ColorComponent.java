...
public class ColorComponent extends SettingComponent<Color, ColorSetting> {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (getClickGui().get().getBoxes())
            ...
            Render2DUtil.drawBorderedRect(getFinishedX() + getWidth() - 20, getFinishedY() + 4.5f, getFinishedX() + getWidth() - 5.5f, getFinishedY() + 11, 0.5f, getColorSetting().getRGB(), 0xff000000);
        ...
        if (isColorExtended()) {
            ...
            Render2DUtil.drawGradientRect(colorPickerLeft, alphaSliderBottom + 2, colorPickerLeft + ((getWidth() - 16) / 2), alphaSliderBottom + 14, false, getClickGui().get().getModulesColor().getRGB(), getClickGui().get().getModulesColor().darker().darker().getRGB());
            ...
            Render2DUtil.drawGradientRect(hueSliderRight - ((getWidth() - 16) / 2), alphaSliderBottom + 2, hueSliderRight, alphaSliderBottom + 14, false, getClickGui().get().getModulesColor().getRGB(), getClickGui().get().getModulesColor().darker().darker().getRGB());
            ...
            if (getColorSetting() != Managers.COLOR.getColorSetting()) {
                ...
                Render2DUtil.drawBorderedRect(hueSliderRight - 12, alphaSliderBottom + 16, hueSliderRight, alphaSliderBottom + 28, 0.5f, getColorSetting().isSync() ? (hoveredSync ? getClickGui().get().getModulesColor().brighter().getRGB() : getClickGui().get().getModulesColor().getRGB()) : (hoveredSync ? 0x66333333 : 0), 0xff000000);
            ...
            if (getColorSetting().isRainbow()) {
                ...
                Render2DUtil.drawBorderedRect(colorPickerLeft, offset + 36.5f, colorPickerLeft + lengthSpeed, offset + 38.5f, 0.5f, hoveredSpeed ? getClickGui().get().getModulesColor().brighter().getRGB() : getClickGui().get().getModulesColor().getRGB(), 0xff000000);
                if (slidingSpeed) {
                ...
                Render2DUtil.drawBorderedRect(colorPickerLeft, offset + 50.5f, colorPickerLeft + lengthSaturation, offset + 52.5f, 0.5f, hoveredSaturation ? getClickGui().get().getModulesColor().brighter().getRGB() : getClickGui().get().getModulesColor().getRGB(), 0xff000000);
                ...
                Render2DUtil.drawBorderedRect(colorPickerLeft, offset + 64.5f, colorPickerLeft + lengthBrightness, offset + 66.5f, 0.5f, hoveredBrightness ? getClickGui().get().getModulesColor().brighter().getRGB() : getClickGui().get().getModulesColor().getRGB(), 0xff000000);
