...
//TODO: make an opposire rendering mode for the dynamic hud module

public class ArrayEntry extends ArrayList implements Globals {
    ...
    public void drawArrayEntry(float desiredX, float desiredY) {
        ...
        if (module.isEnabled() && module.isHidden() != Hidden.Hidden) {
            ...
            if (!shouldDelete()) {
                ...
                ArrayList.getRemoveEntries().put(module,this);
            }
            setAtDesired(false);
            stopWatch.reset();
        }
