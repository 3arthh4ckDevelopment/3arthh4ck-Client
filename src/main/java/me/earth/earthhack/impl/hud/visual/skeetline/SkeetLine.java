...
public class SkeetLine extends HudElement {
    ...
    private void render() {
        ...
        if (skeetLineGradient.getValue()) {
            Render2DUtil.drawGradientRect(0, 0, Render2DUtil.getScreenWidth(), skeetLineWidth.getValue(), true, skeetLineColor.getValue().getRGB(), skeetLineColorGradient.getValue().getRGB());
        } else {
            Render2DUtil.drawRect(0, 0, Render2DUtil.getScreenWidth(), skeetLineWidth.getValue(), skeetLineColor.getValue().getRGB());
        }
