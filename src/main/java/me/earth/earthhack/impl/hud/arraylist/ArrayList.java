...
public class ArrayList extends DynamicHudElement {
    ...
    protected static final Map<Module, ArrayEntry> removeEntries = new HashMap<>();
    protected final List<Map.Entry<String, Module>> modules = new java.util.ArrayList<>();
    protected Map<Module, ArrayEntry> arrayEntriesSorted;
    ...
    private void renderModules() {
        ...
        float yPos = (directionV() == TextDirectionV.BottomToTop ? getY() - Managers.TEXT.getStringHeight() * 2 : getY());
    ...
    public static Map<Module, ArrayEntry> getRemoveEntries() {
        return removeEntries;
    }

    public ArrayList() {
        super("ArrayList", 200, 200);
