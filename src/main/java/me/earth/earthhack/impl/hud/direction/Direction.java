package me.earth.earthhack.impl.hud.direction;
...
public class Direction extends HudElement {
    ...
    public String getDirection4D(boolean name, boolean symbol)
    {
        ...
        switch (RotationUtil.getDirection4D())
        {
            case 0:
                nameValue = "South";
                symbolValue = symbolBuider("+Z", name);
                break;
            case 1:
                nameValue = "West";
                symbolValue = symbolBuider("-X", name);
                break;
            case 2:
                nameValue = "North";
                symbolValue = symbolBuider("-Z", name);
    ...
    private String symbolBuider(String dir, boolean name) {
        if (!name)
            return dir;
