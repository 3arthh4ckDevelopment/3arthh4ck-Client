...
public class Binds extends DynamicHudElement {
    ...
    protected void onRender() {
        ...
        for (Module m : modules) {
            HudRenderUtil.renderText( (showStatus.getValue() ? (m.isEnabled() ? enabledColor.getValue().getColor() : disabledColor.getValue().getColor()) : "") + m.getDisplayName() + TextColor.GRAY + " " + (showBind.getValue() ? surroundWithBrackets(bindColor.getValue().getColor() + Keyboard.getKeyName(m.getBind().getKey())) : ""),
