package me.earth.earthhack.impl.hud.coordinates;
...
public class Coordinates extends HudElement {
    ...
    private Vec3i smartCoords() {
        if (MathUtil.distance2D(new Vec3d(mc.player.posX, 0, mc.player.posZ), new Vec3d(0,0,0)) < 5000) {
