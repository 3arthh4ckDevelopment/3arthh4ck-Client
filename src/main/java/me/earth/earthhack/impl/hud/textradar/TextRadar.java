package me.earth.earthhack.impl.hud.textradar;
...
public class TextRadar extends DynamicHudElement {
    ...
    private final Setting<Boolean> direction =
            register(new BooleanSetting("Display-Direction", false));
    ...
    public TextRadar() {
        super("TextRadar", 60, 70);
        this.setData(new SimpleHudData(this, "Displays the names and health of enemies near you."));
    }
