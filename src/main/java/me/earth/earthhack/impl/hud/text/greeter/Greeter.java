...
public class Greeter extends HudElement {
    ...
    protected void onRender() {
        String name = RotationUtil.getRotationPlayer().getDisplayName().getFormattedText();
        String playerName = Caches.getModule(Media.class).returnIfPresent(m -> m.convert(name), name);
        HudRenderUtil.renderText(text = greeterMode.getValue().getString(playerName), getX(), getY());
    }
