...
import me.earth.earthhack.impl.core.transformer.patch.EarthhackPatcher;
import me.earth.earthhack.impl.core.transformer.patch.patches.*;
...
public class EarthhackTransformer implements IClassTransformer
{
    ...
    private void loadReentrantClasses()
    {
        try
        {
            Class.forName(AsmUtil.class.getName());
            Class.forName(ReflectionUtil.class.getName());
            BlockPosPatch.BlockPosPatchLoader.loader();
            /*
