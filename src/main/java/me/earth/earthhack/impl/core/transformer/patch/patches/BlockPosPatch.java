package me.earth.earthhack.impl.core.transformer.patch.patches;

import me.earth.earthhack.impl.Earthhack;
import me.earth.earthhack.impl.core.Core;
import me.earth.earthhack.impl.core.transformer.patch.ArgumentPatch;
...

{
    ...
    public static class BlockPosPatchLoader extends BlockPosPatch {
        public static void loader() throws ClassNotFoundException {
            try {
                Class.forName(BlockPosPatch.class.getName() + "$1");
            } catch (ClassNotFoundException e) {
                Earthhack.getLogger().warn("!!DETECTED MODIFIED CLASS FILES!!");
                Earthhack.getLogger().warn("(This might be caused by obfuscation)");
                Class.forName(BlockPosPatch.class.getName());
            }

            Class.forName(OffsetPatch.class.getName());
            Class.forName(Direction.class.getName());
        }
    }
